...
public class MainActivity extends AppCompatActivity {
    ...
    private CallBack dataChangeCallBack() {
        return rezultat -> {
          produse.clear();
    ...
    private void initComponente() {
        ...
        ArrayAdapter<Produs> adapter = new ArrayAdapter<>(getApplicationContext(),android.R.layout.simple_list_item_1, produse);
    ...
    private Produs actualizareProdusFromUI(String id) {
        ...
        produs.setPret(Float.parseFloat(etPret.getText().toString()));
        return produs;
    }
